// Fix Encrypted Data
// This script fixes the corrupted encrypted data in your database
// Run with: node src/fix-encrypted-data.js
...
function convertJsonBufferToBinary(jsonBufferString) {
  try {
    ...
    const bufferObj = JSON.parse(jsonBufferString);
...
async function fixEncryptedData() {
  console.log("=== Fix Encrypted Data ===");
  console.log("Fixing the corrupted encrypted data in your database...");
